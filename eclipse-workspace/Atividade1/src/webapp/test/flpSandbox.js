		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "busca_de_imagens",
									"targetURL": "#buscadeimagensgoogleimagens-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"buscadeimagensgoogleimagens-display": {
								"semanticObject": "buscadeimagensgoogleimagens",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=buscadeimagens.googleimagens",
									"url": sap.ui.require.toUrl("buscadeimagens/googleimagens")
								}
							}
						}
					}
